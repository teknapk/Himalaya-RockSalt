                ...
                <div class="main-box">
                    <div id="carouselExampleIndicators" class="carousel slide" data-ride="carousel">
                        ...
                        <div class="carousel-inner">
                            ...
                            <img class="d-block w-100" src="{{ asset("Assests/Home/heavy_slider.jpg")}}"
                                    alt="Second slide" id="d-block"> 
                            </div>
                            <div class="carousel-item">
                              
                                    <img class="d-block w-100" src="{{ asset("Assests/Home/heavy_slider2.jpg")}}"
                   ...
                   <a href="{{route('description',[  'id' => '1' ])}}">
                    ...
                    <div class="row">
                        <div class="col-xl-4 col-lg-4 col-md-4 col-sm-6 col-xs-6 col-6">
                            <div class="card ">
                                <div class="card-body">
                                    <img class="card-img" src="{{asset('Assests/Theuraputic_salt/img1.png') }}">
                                    <h4 class="card-text">15” Bowl</h4>
                                    <!-- <a href="{{route('Product-Details',[ 'id' => 1 ])}}" class="btn for_more">Read
                                        More</a> -->
                                </div>
                            </div>
                        </div>
                        <div class="col-xl-4 col-lg-4 col-md-4 col-sm-6 col-xs-6 col-6">
                            <div class="card ">
                                <div class="card-body">
                                    <img class="card-img" src="{{asset('Assests/Theuraputic_salt/img5.png') }}">
                                    <h4 class="card-text">16” wide Lotus Heavy Lamp</h4>
                                    <!-- <a href="{{route('Product-Details',[ 'id' => 5 ])}}" class="btn for_more">Read
                                        More</a> -->
                                </div>
                            </div>
                        </div>
                        <div class="col-xl-4 col-lg-4 col-md-4 col-sm-6 col-xs-6 col-6">
                            <div class="card ">
                                <div class="card-body">
                                    <img class="card-img" src="{{asset('Assests/Theuraputic_salt/img15.png') }}">
                                    <h4 class="card-text">Egg Shaped Heavy Lamp</h4>
                                    <!-- <a href="{{route('Product-Details',[ 'id' => 84 ])}}" class="btn for_more">Read
                                        More</a> -->
                                </div>
                            </div>
                        </div>
                        <div class="col-xl-4 col-lg-4 col-md-4 col-sm-6 col-xs-6 col-6">
                            <div class="card ">
                                <div class="card-body">
                                    <img class="card-img" src="{{asset('Assests/Theuraputic_salt/img16.png') }}">
                                    <h4 class="card-text">Heavy Natural lamp with Lotus</h4>
                                    <!-- <a href="{{route('Product-Details',[ 'id' => 15 ])}}" class="btn for_more">Read
                                        More</a> -->
                                </div>
                            </div>
                        </div>
                        <div class="col-xl-4 col-lg-4 col-md-4 col-sm-6 col-xs-6 col-6">
                            <div class="card ">
                                <div class="card-body">
                                    <img class="card-img" src="{{asset('Assests/Theuraputic_salt/img21.png') }}">
                                    <h4 class="card-text">superHeavy Lamp</h4>
                                    <!-- <a href="{{route('Product-Details',[ 'id' => 83 ])}}" class="btn for_more">Read
                                        More</a> -->
                                </div>
                            </div>
                        </div>
                        <div class="col-xl-4 col-lg-4 col-md-4 col-sm-6 col-xs-6 col-6">
                            <div class="card ">
                                <div class="card-body">
                                    <img class="card-img" src="{{asset('Assests/Theuraputic_salt/img22.png') }}">
                                    <h4 class="card-text">Heavy Lamp</h4>
                                    <!-- <a href="{{route('Product-Details',[ 'id' => 82 ])}}" class="btn for_more">Read
                                        More</a> -->
                                </div>
                            </div>
                        </div>
                        <div class="col-xl-4 col-lg-4 col-md-4 col-sm-6 col-xs-6 col-6">
                            <div class="card ">
                                <div class="card-body">
                                    <img class="card-img" src="{{asset('Assests/Theuraputic_salt/img23.png') }}">
                                    <h4 class="card-text">Heavy Lotus with 12: Globe Lamp</h4>
                                    <!-- <a href="{{route('Product-Details',[ 'id' => 81 ])}}" class="btn for_more">Read
                                        More</a> -->
                                </div>
                            </div>
                        </div>
                        <div class="col-xl-4 col-lg-4 col-md-4 col-sm-6 col-xs-6 col-6">
                            <div class="card ">
                                <div class="card-body">
                                    <img class="card-img" src="{{asset('Assests/Theuraputic_salt/img18.png') }}">
                                    <h4 class="card-text">24” Lotus with 16” Globe (Ball)</h4>
                                    <!-- <a href="{{route('Product-Details',[ 'id' => 17 ])}}" class="btn for_more">Read
                                        More</a> -->
                                </div>
                            </div>
                        </div>
                        <div class="col-xl-4 col-lg-4 col-md-4 col-sm-6 col-xs-6 col-6">
                            <div class="card ">
                                <div class="card-body">
                                    <img class="card-img" src="{{asset('Assests/Theuraputic_salt/super_lamp.jpg') }}">
                                    <h4 class="card-text">SUPER LAMPS 100-250 KG</h4>
                                    <!-- <a href="{{route('Product-Details',[ 'id' => 17 ])}}" class="btn for_more">Read
                                        More</a> -->
                                </div>
                            </div>
                        ...
                        <div class="col-xl-4 col-lg-4 col-md-4 col-sm-6 col-xs-6 col-6">
                            <div class="card ">
                                <div class="card-body">
                                    <img class="card-img" src="{{asset('Assests/Theuraputic_salt/boat_lamp.jpg') }}">
                                    <h4 class="card-text">SUPER BOAT LAMP 24 INCHES</h4>
                                    <!-- <a href="{{route('Product-Details',[ 'id' => 17 ])}}" class="btn for_more">Read
                                        More</a> -->
                                </div>
                            </div>
                        ...
                        <div class="col-xl-4 col-lg-4 col-md-4 col-sm-6 col-xs-6 col-6">
                            <div class="card ">
                                <div class="card-body">
                                    <img class="card-img" src="{{asset('Assests/Theuraputic_salt/globe_lamp.jpg') }}">
                                    <h4 class="card-text">SUPER GLOBE 16 INCHES</h4>
                                    <!-- <a href="{{route('Product-Details',[ 'id' => 17 ])}}" class="btn for_more">Read
                                        More</a> -->
                                </div>
                            </div>
                        ...
                        <div class="col-xl-4 col-lg-4 col-md-4 col-sm-6 col-xs-6 col-6">
                            <div class="card ">
                                <div class="card-body">
                                    <img class="card-img" src="{{asset('Assests/Theuraputic_salt/globe_large.jpg') }}">
                                    <h4 class="card-text">GLOBE LAMPS LARGE 9-16 INCHES</h4>
                                    <!-- <a href="{{route('Product-Details',[ 'id' => 17 ])}}" class="btn for_more">Read
                                        More</a> -->
                                </div>
                            </div>

            ...
            <div class="col-xl-7 col-lg-7 col-md-10 col-sm-12 col-xs-12 col-12 mt-4">
                <div class="main-box">
                    <div id="carouselExampleIndicators" class="carousel slide" data-ride="carousel">
                        ...
                        <div class="carousel-inner">
                            <div class="carousel-item active">
                                <img class="d-block w-100" src="{{asset('Assests/Home/bath.jpg') }}"
                                    alt="First slide" id="d-block">
                            </div>
                            <div class="carousel-item">
                                <img class="d-block w-100" src="{{asset('Assests/Home/health_slider.jpg') }}"
                    ...
                    <div class="row pt-2">
                        ...
                        <div class=" col-xl-12 col-lg-12 col-md-12 col-sm-6 col-6 text-right mob_margin">
                   <a href="{{route('description',[  'id' => '7' ])}}">
                    ...
                    <div class="row">
                        <div class="col-xl-4 col-lg-4 col-md-4 col-sm-6 col-xs-6 col-6">
                            <div class="card ">
                                <div class="card-body">
                                    <img class="card-img" src="{{asset('Assests/Salt_HealthCare/11.png') }}">
                                    <h4 class="card-text">Lumbar Belt </h4>
                                    <!-- <a href="{{route('Product-Details',[ 'id' => 36 ])}}" class="btn for_more">Read
                                        More</a> -->
                                </div>
                            </div>
                        </div>
                        <div class="col-xl-4 col-lg-4 col-md-4 col-sm-6 col-xs-6 col-6">
                            <div class="card ">
                                <div class="card-body">
                                    <img class="card-img" src="{{asset('Assests/Salt_HealthCare/12.png') }}">
                                    <h4 class="card-text">Pain Relief Pouch</h4>
                                    <!-- <a href=" {{route('Product-Details',[ 'id' => 37])}}" class="btn for_more">Read
                                        More</a> -->
                                </div>
                            </div>
                        </div>
                        <div class="col-xl-4 col-lg-4 col-md-4 col-sm-6 col-xs-6 col-6">
                            <div class="card ">
                                <div class="card-body">
                                    <img class="card-img" src="{{asset('Assests/Salt_HealthCare/13.png') }}">
                                    <h4 class="card-text">Inhaler & Nettipot</h4>
                                    <!-- <a href="{{route('Product-Details',[ 'id' => 38 ])}}" class="btn for_more">Read
                                        More</a> -->
                                </div>
                            </div>
                        </div>
                        <div class="col-xl-4 col-lg-4 col-md-4 col-sm-6 col-xs-6 col-6">
                            <div class="card ">
                                <div class="card-body">
                                    <img class="card-img" src="{{asset('Assests/Salt_HealthCare/14.png') }}">
                                    <h4 class="card-text">Nasal Pot </h4>
                                    <!-- <a href="{{route('Product-Details',[ 'id' => 39 ])}}" class="btn for_more">Read
                                        More</a> -->
                                </div>
                            </div>
                        </div>
                        <div class="col-xl-4 col-lg-4 col-md-4 col-sm-6 col-xs-6 col-6">
                            <div class="card ">
                                <div class="card-body">
                                    <img class="card-img" src="{{asset('Assests/Salt_HealthCare/15.png') }}">
                                    <h4 class="card-text">Ceramic Inhaler Salt </h4>
                                    <!-- <a href="{{route('Product-Details',[ 'id' => 40 ])}}" class="btn for_more">Read
                                        More</a> -->
                                </div>
                            </div>
                        </div>
                        <div class="col-xl-4 col-lg-4 col-md-4 col-sm-6 col-xs-6 col-6">
                            <div class="card ">
                                <div class="card-body">
                                    <img class="card-img" src="{{asset('Assests/Salt_HealthCare/16.png') }}">
                                    <h4 class="card-text">Health Care</h4>
                                    <!-- <a href="{{route('Product-Details',[ 'id' => 41 ])}}" class="btn for_more">Read
                                        More</a> -->
                                </div>
                            </div>
                        </div>

                    ...
                    <div id="carouselExampleIndicators" class="carousel slide" data-ride="carousel">
                        ...
                        <div class="carousel-inner">
                            <div class="carousel-item active">
                                <img class="d-block w-100" src="{{asset('Assests/Home/spa_slider.jpg') }}"
                                    alt="First slide" id="d-block">
                            </div>
                            <div class="carousel-item">
                                <img class="d-block w-100" src="{{asset('Assests/Home/spa_slider2.png') }}"
                   ...
                   <a href="{{route('description',[  'id' => '3' ])}}">
                    ...
                    <div class="row">
                        <div class="col-xl-4 col-lg-4 col-md-4 col-sm-6 col-xs-6 col-6">
                            <div class="card ">
                                <div class="card-body">
                                    <img class="card-img" src="{{asset('Assests/Spa_Bath/1.png') }}">
                                    <h4 class="card-text">Egg shape Massage Stone</h4>
                                    <!-- <a href="{{route('Product-Details',[ 'id' => 24])}}" class="btn for_more">Read
                                        More</a> -->
                                </div>
                            </div>
                        </div>
                        <div class="col-xl-4 col-lg-4 col-md-4 col-sm-6 col-xs-6 col-6">
                            <div class="card ">
                                <div class="card-body">
                                    <img class="card-img" src="{{asset('Assests/Spa_Bath/sb-2.jpg') }}">
                                    <h4 class="card-text">Foot Detox Plates</h4>
                                    <!-- <a href="{{route('Product-Details',[ 'id' => 78])}}" class="btn for_more">Read
                                        More</a> -->
                                </div>
                            </div>
                        </div>
                        <div class="col-xl-4 col-lg-4 col-md-4 col-sm-6 col-xs-6 col-6">
                            <div class="card ">
                                <div class="card-body">
                                    <img class="card-img" src="{{asset('Assests/Spa_Bath/2.png') }}">
                                    <h4 class="card-text">Oval Massage Stones</h4>
                                    <!-- <a href="{{route('Product-Details',[ 'id' => 25])}}" class="btn for_more">Read
                                        More</a> -->
                                </div>
                            </div>
                        </div>
                        <div class="col-xl-4 col-lg-4 col-md-4 col-sm-6 col-xs-6 col-6">
                            <div class="card ">
                                <div class="card-body">
                                    <img class="card-img" src="{{asset('Assests/Spa_Bath/3.png') }}">
                                    <h4 class="card-text">2” Hand Sanitizer & Massage Ball</h4>
                                    <!-- <a href="{{route('Product-Details',[ 'id' => 26])}}" class="btn for_more">Read
                                        More</a> -->
                                </div>
                            </div>
                        </div>
                        <div class="col-xl-4 col-lg-4 col-md-4 col-sm-6 col-xs-6 col-6">
                            <div class="card ">
                                <div class="card-body">
                                    <img class="card-img" src="{{asset('Assests/Spa_Bath/4.png') }}">
                                    <h4 class="card-text">Bath Crystals</h4>
                                    <!-- <a href="{{route('Product-Details',[ 'id' => 27])}}" class="btn for_more">Read
                                        More</a> -->
                                </div>
                            </div>
                        </div>
                        <div class="col-xl-4 col-lg-4 col-md-4 col-sm-6 col-xs-6 col-6">
                            <div class="card ">
                                <div class="card-body">
                                    <img class="card-img" src="{{asset('Assests/Spa_Bath/5.png') }}">
                                    <h4 class="card-text">Body scrub Salt</h4>
                                    <!-- <a href="{{route('Product-Details',[ 'id' => 28])}}" class="btn for_more">Read
                                        More</a> -->
                                </div>
                            </div>
                        </div>
                        <div class="col-xl-4 col-lg-4 col-md-4 col-sm-6 col-xs-6 col-6">
                            <div class="card ">
                                <div class="card-body">
                                    ...
                                    <img class="card-img" src="{{asset('Assests/Spa_Bath/6.png') }}">
                                    <h4 class="card-text">Heart Shape Massage Stones</h4>
                        ...
                        <div class="col-xl-4 col-lg-4 col-md-4 col-sm-6 col-xs-6 col-6">
                            <div class="card ">
                                <div class="card-body">
                                    <img class="card-img" src="{{asset('Assests/Spa_Bath/sb-8.jpg') }}">
                                    <h4 class="card-text">Bath Bars</h4>
                                    <!-- <a href="{{route('Product-Details',[ 'id' => 79])}}" class="btn for_more">Read
                                        More</a> -->
                                </div>
                            </div>
                        </div>
                        <div class="col-xl-4 col-lg-4 col-md-4 col-sm-6 col-xs-6 col-6">
                            <div class="card ">
                                <div class="card-body">
                                    <img class="card-img" src="{{asset('Assests/Spa_Bath/bodymassage.jpg') }}">
                                    <h4 class="card-text">Body Massage Stones</h4>
                                    <!-- <a href="{{route('Product-Details',[ 'id' => 79])}}" class="btn for_more">Read
                                        More</a> -->
                                </div>
                            </div>
                        ...
                        <div class="col-xl-4 col-lg-4 col-md-4 col-sm-6 col-xs-6 col-6">
                            <div class="card ">
                                <div class="card-body">
                                    <img class="card-img" src="{{asset('Assests/Spa_Bath/massage.jpg') }}">
                                    <h4 class="card-text">Massage Stones</h4>
                                    <!-- <a href="{{route('Product-Details',[ 'id' => 79])}}" class="btn for_more">Read
                                        More</a> -->
                                </div>
                            </div>
                        ...
                        <div class="col-xl-4 col-lg-4 col-md-4 col-sm-6 col-xs-6 col-6">
                            <div class="card ">
                                <div class="card-body">
                                    <img class="card-img" src="{{asset('Assests/Spa_Bath/facial.jpg') }}">
                                    <h4 class="card-text">GUA SHA Facial Tools</h4>
                                    <!-- <a href="{{route('Product-Details',[ 'id' => 79])}}" class="btn for_more">Read
                                        More</a> -->
                                </div>
                            </div>
...
<!--                         
                        <div class="col-xl-4 col-lg-4 col-md-4 col-sm-6 col-xs-6 col-6">
                            <div class="card ">
                                <div class="card-body">
                                    <img class="card-img" src="{{asset('Assests/Spa_Bath/heartshape.jpg') }}">
                                    <h4 class="card-text">Heart Shape Massage Stones</h4>
                        ...
                        <div class="col-xl-4 col-lg-4 col-md-4 col-sm-6 col-xs-6 col-6">
                            <div class="card ">
                                <div class="card-body">
                                    <img class="card-img" src="{{asset('Assests/Spa_Bath/spa.jpg') }}">
                                    <h4 class="card-text">Spa and Bath</h4>
                                    <!-- <a href="{{route('Product-Details',[ 'id' => 79])}}" class="btn for_more">Read
                                        More</a> -->
                                </div>
                            </div>
                        ...
                        <!-- <div class="col-xl-4 col-lg-4 col-md-4 col-sm-6 col-xs-6 col-6">
                            <div class="card ">
                                <div class="card-body">
                                    <img class="card-img" src="{{asset('Assests/Spa_Bath/bath.jpg') }}">
                                    <h4 class="card-text">Spa and Bath</h4>
                        ...
                        <div class="col-xl-4 col-lg-4 col-md-4 col-sm-6 col-xs-6 col-6">
                            <div class="card ">
                                <div class="card-body">
                                    <img class="card-img" src="{{asset('Assests/Spa_Bath/various.jpg') }}">
                                    <h4 class="card-text">Various Spa Items</h4>
                                    <!-- <a href="{{route('Product-Details',[ 'id' => 79])}}" class="btn for_more">Read
                                        More</a> -->
                                </div>
                            </div>
                        ...
                        <div class="col-xl-4 col-lg-4 col-md-4 col-sm-6 col-xs-6 col-6">
                            <div class="card ">
                                <div class="card-body">
                                    <img class="card-img" src="{{asset('Assests/Spa_Bath/signature.jpg') }}">
                                    <h4 class="card-text">Signature Pack Bath</h4>
                                    <!-- <a href="{{route('Product-Details',[ 'id' => 79])}}" class="btn for_more">Read
                                        More</a> -->
                                </div>
                            </div>
                        ...
                        <div class="col-xl-4 col-lg-4 col-md-4 col-sm-6 col-xs-6 col-6">
                            <div class="card ">
                                <div class="card-body">
                                    <img class="card-img" src="{{asset('Assests/Spa_Bath/oval_stone.jpg') }}">
                                    <h4 class="card-text">Oval Massage Stones	</h4>
                                    <!-- <a href="{{route('Product-Details',[ 'id' => 79])}}" class="btn for_more">Read
                                        More</a> -->
                                </div>
                        ...
                        <div class="col-xl-4 col-lg-4 col-md-4 col-sm-6 col-xs-6 col-6">
                            <div class="card ">
                                <div class="card-body">
                                    <img class="card-img" src="{{asset('Assests/Spa_Bath/foot_detox.png') }}">
                                    <h4 class="card-text">FOOT DETOX LAMP	</h4>
                                    <!-- <a href="{{route('Product-Details',[ 'id' => 79])}}" class="btn for_more">Read
                                        More</a> -->
                                </div>
                            </div>
                        ...
                        <div class="col-xl-4 col-lg-4 col-md-4 col-sm-6 col-xs-6 col-6">
                            <div class="card ">
                                <div class="card-body">
                                    <img class="card-img" src="{{asset('Assests/Spa_Bath/sanitizer.jpg') }}">
                                    <h4 class="card-text">2” BALL HAND SANITIZER</h4>
                                    <!-- <a href="{{route('Product-Details',[ 'id' => 79])}}" class="btn for_more">Read
                                        More</a> -->
                                </div>
                            </div>
                        ...
                        <div class="col-xl-4 col-lg-4 col-md-4 col-sm-6 col-xs-6 col-6">
                            <div class="card ">
                                <div class="card-body">
                                    <img class="card-img" src="{{asset('Assests/Spa_Bath/signature_packing.jpg') }}">
                                    <h4 class="card-text">SIGNATURE PACKING SPA ITEMS</h4>
                                    <!-- <a href="{{route('Product-Details',[ 'id' => 79])}}" class="btn for_more">Read
                                        More</a> -->
                                </div>
                            </div>

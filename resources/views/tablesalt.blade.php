                ...
                <div class="main-box">
                    <div id="carouselExampleIndicators" class="carousel slide" data-ride="carousel">
                        ...
                        <div class="carousel-inner">
                            <div class="carousel-item active">
                                <img class="d-block w-100" src="{{asset('Assests/Home/food_slider.jpg') }}"
                                    alt="First slide" id="d-block">
                            </div>
                            <div class="carousel-item">
                                <img class="d-block w-100" src="{{asset('Assests/Home/food_slider2.jpg') }}"
                    ...
                    <div class="row">
                        <div class="col-xl-4 col-lg-4 col-md-4 col-sm-6 col-xs-6 col-6">
                            <div class="card ">
                                <div class="card-body">
                                    <img class="card-img" src="{{asset('Assests/Table_Salt/img55.png') }}">
                                    <h4 class="card-text">1-2 MM Mid Pink</h4>
                                    <!-- <a href="{{route('Product-Details',[ 'id' => 20 ])}}" class="btn for_more">Read
                                        More</a> -->
                                </div>
                            </div>
                        </div>
                        <div class="col-xl-4 col-lg-4 col-md-4 col-sm-6 col-xs-6 col-6">
                            <div class="card ">
                                <div class="card-body">
                                    <img class="card-img" src="{{asset('Assests/Table_Salt/img56.png') }}">
                                    <h4 class="card-text">Dark Pink Crystal</h4>
                                    <!-- <a href="{{route('Product-Details',[ 'id' => 21 ])}}" class="btn for_more">Read
                                        More</a> -->
                                </div>
                            </div>
                        </div>
                        <div class="col-xl-4 col-lg-4 col-md-4 col-sm-6 col-xs-6 col-6">
                            <div class="card ">
                                <div class="card-body">
                                    <img class="card-img" src="{{asset('Assests/Table_Salt/img57.png') }}">
                                    <h4 class="card-text">2-6 MM Pink Salt </br> AAA Grade</h4>
                                    <!-- <a href="{{route('Product-Details',[ 'id' => 22 ])}}" class="btn for_more">Read
                                        More</a> -->
                                </div>
                            </div>
                        </div>
                        <div class="col-xl-4 col-lg-4 col-md-4 col-sm-6 col-xs-6 col-6">
                            <div class="card ">
                                <div class="card-body">
                                    <!-- <img class="card-img" src="{{asset('Assests/Table_Salt/img58.png') }}"> -->
                                    <h4 class="card-text">Corse Salt</h4>
                                    <!-- <a href="{{route('Product-Details',[ 'id' => 23 ])}}" class="btn for_more">Read
                                        More</a> -->
                                </div>
                            </div>
                        </div>
                        <div class="col-xl-4 col-lg-4 col-md-4 col-sm-6 col-xs-6 col-6">
                            <div class="card ">
                                <div class="card-body">
                                    <img class="card-img" src="{{asset('Assests/Table_Salt/Picture12.jpg') }}">
                                    <h4 class="card-text">VARIOUS SALT SHADES SALT</h4>
                                    <!-- <a href="{{route('Product-Details',[ 'id' => 23 ])}}" class="btn for_more">Read
                                        More</a> -->
                                </div>
                            </div>
                        ...
                        <div class="col-xl-4 col-lg-4 col-md-4 col-sm-6 col-xs-6 col-6">
                            <div class="card ">
                                <div class="card-body">
                                    <img class="card-img" src="{{asset('Assests/Table_Salt/Picture13.jpg') }}">
                                    <h4 class="card-text">AAA GRADE PINK</h4>
                                    <!-- <a href="{{route('Product-Details',[ 'id' => 23 ])}}" class="btn for_more">Read
                                        More</a> -->
                                </div>
                            </div>
                        ...
                        <div class="col-xl-4 col-lg-4 col-md-4 col-sm-6 col-xs-6 col-6">
                            <div class="card ">
                                <div class="card-body">
                                    <img class="card-img" src="{{asset('Assests/Table_Salt/Picture14.jpg') }}">
                                    <h4 class="card-text"> PALLETIZED BULK PACK PACKINS</h4>
                                    <!-- <a href="{{route('Product-Details',[ 'id' => 23 ])}}" class="btn for_more">Read
                                        More</a> -->
                                </div>
                            </div>
                        ...
                        <div class="col-xl-4 col-lg-4 col-md-4 col-sm-6 col-xs-6 col-6">
                            <div class="card ">
                                <div class="card-body">
                                    <img class="card-img" src="{{asset('Assests/Table_Salt/Picture15.jpg') }}">
                                    <h4 class="card-text">25 KG PP BAGS WITH INNER LINER</h4>
                                    <!-- <a href="{{route('Product-Details',[ 'id' => 23 ])}}" class="btn for_more">Read
                                        More</a> -->
                                </div>
                            </div>
                        ...
                        <div class="col-xl-4 col-lg-4 col-md-4 col-sm-6 col-xs-6 col-6">
                            <div class="card ">
                                <div class="card-body">
                                    <img class="card-img" src="{{asset('Assests/Table_Salt/Picture16.jpg') }}">
                                    <h4 class="card-text">PLASTIC PALLETS </h4>
                        ...
                        <div class="col-xl-4 col-lg-4 col-md-4 col-sm-6 col-xs-6 col-6">
                            <div class="card ">
                                <div class="card-body">
                                    <img class="card-img" src="{{asset('Assests/Table_Salt/pouches.jpg') }}">
                                    <h4 class="card-text">BRANDED POUCHES </h4>
                        ...
                        <div class="col-xl-4 col-lg-4 col-md-4 col-sm-6 col-xs-6 col-6">
                            <div class="card ">
                                <div class="card-body">
                                    <img class="card-img" src="{{asset('Assests/Table_Salt/shades.jpg') }}">
                                    <h4 class="card-text">SALT SHADES VARIOUS</h4>
                        ...
                        <div class="col-xl-4 col-lg-4 col-md-4 col-sm-6 col-xs-6 col-6">
                            <div class="card ">
                                <div class="card-body">
                                    <img class="card-img" src="{{asset('Assests/Table_Salt/branded.jpg') }}">
                                    <h4 class="card-text">BRANDED PACKS </h4>
                        ...
                        <div class="col-xl-4 col-lg-4 col-md-4 col-sm-6 col-xs-6 col-6">
                            <div class="card ">
                                <div class="card-body">
                                    <img class="card-img" src="{{asset('Assests/Table_Salt/various_grain.jpg') }}">
                                    <h4 class="card-text">VARIOUS SHADES & GRAINS OF SALT </h4>
                        ...
                        <div class="col-xl-4 col-lg-4 col-md-4 col-sm-6 col-xs-6 col-6">
                            <div class="card ">
                                <div class="card-body">
                                    <img class="card-img" src="{{asset('Assests/Table_Salt/fine_grain.jpg') }}">
                                    <h4 class="card-text"> PINK FINE GRAIN  </h4>
                        ...
                        <div class="col-xl-4 col-lg-4 col-md-4 col-sm-6 col-xs-6 col-6">
                            <div class="card ">
                                <div class="card-body">
                                    <img class="card-img" src="{{asset('Assests/Table_Salt/extra_fine.jpg') }}">
                                    <h4 class="card-text">PINK EXTRA FINE GRAIN </h4>
                        ...
                        <div class="col-xl-4 col-lg-4 col-md-4 col-sm-6 col-xs-6 col-6">
                            <div class="card ">
                                <div class="card-body">
                                    <img class="card-img" src="{{asset('Assests/Table_Salt/pink_crystal.jpg') }}">
                                    <h4 class="card-text">Pink Salt Crystal 2-5mm AAA Grade </h4>
                        ...
                        <div class="col-xl-4 col-lg-4 col-md-4 col-sm-6 col-xs-6 col-6">
                            <div class="card ">
                                <div class="card-body">
                                    <img class="card-img" src="{{asset('Assests/Table_Salt/dark_pink.jpg') }}">
                                    <h4 class="card-text">Dark Pink Salt Coarse 2-5mm A Grade</h4>
                        ...
                        <!-- <div class="col-xl-4 col-lg-4 col-md-4 col-sm-6 col-xs-6 col-6">
                            <div class="card ">
                                <div class="card-body">
                                    <img class="card-img" src="{{asset('Assests/Table_Salt/Picture17.jpg') }}">
                                    <h4 class="card-text">SALT VARIOUS GRADES AND SHADES</h4>

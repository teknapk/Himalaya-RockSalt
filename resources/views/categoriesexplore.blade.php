                ...
                <div class="main-box">
                    <div id="carouselExampleIndicators" class="carousel slide" data-ride="carousel">
                        ...
                        <div class="carousel-inner">
                            ...
                            @else
                            <div class="carousel-item active">
                            <img class="d-block w-100" src="{{ asset($categories->img) }}" alt="Category Image"
                                    alt="First slide" id="d-block">
                            </div>
                            <div class="carousel-item">
                                <img class="d-block w-100" src="{{ asset($categories->img2) }}"
                                    alt="Second slide" id="d-block">
                            </div>
                            @endif
                        </div>
                    ...
                    <div class="row pt-2">
                    <!-- <div class="col-xl-6 col-lg-6 col-md-6 col-sm-6 col-xs-6 col-6 mt-3">
                        <div class="mobile_view web_view ">
                        <p>All Products</p>
                        </div>
                   ...
                   <div class="col-xl-6 col-lg-6 col-md-6 text-right">
                    ...
                    <div class="row">
                        ...
                        <div class="col-xl-4 col-lg-4 col-md-4 col-sm-6 col-xs-6 col-6">
                            <div class="card ">
                                <div class="card-body">
                                    <img class="card-img" src="{{ asset($product->img) }}">
                                    <h4 class="card-text">{{$product->name}}</h4>
                                    <!-- <a href="{{ url('Product-Details/'.$product->id) }}" class="btn for_more">Read
                                        More</a> -->
                                </div>
                            </div>
                        </div>

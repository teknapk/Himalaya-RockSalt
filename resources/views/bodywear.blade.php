                    ...
                    <div id="carouselExampleIndicators" class="carousel slide" data-ride="carousel">
                        ...
                        <div class="carousel-inner">
                            <div class="carousel-item active">
                                <img class="d-block w-100" src="{{asset('Assests/Home/body_slider.jpg') }}"
                                    alt="First slide" id="d-block">
                            </div>
                            <div class="carousel-item">
                                <img class="d-block w-100" src="{{asset('Assests/Home/body_slider2.png') }}"
                   ...
                   <a href="{{route('description',[  'id' => '6' ])}}">
                    ...
                    <div class="row">
                        <div class="col-xl-4 col-lg-4 col-md-4 col-sm-6 col-xs-6 col-6">
                            <div class="card ">
                                <div class="card-body">
                                    <img class="card-img" src="{{asset('Assests/Body_wear/8.png') }}">
                                    <h4 class="card-text">Bracelet Salt</h4>
                                    <!-- <a href="{{route('Product-Details',[ 'id' => 43 ])}}" class="btn for_more">Read
                                        More</a> -->
                                </div>
                            </div>
                        </div>
                        <div class="col-xl-4 col-lg-4 col-md-4 col-sm-6 col-xs-6 col-6">
                            <div class="card ">
                                <div class="card-body">
                                    <img class="card-img" src="{{asset('Assests/Body_wear/9.png') }}">
                                    <h4 class="card-text">Pendant Salt</h4>
                                    <!-- <a href="{{route('Product-Details',[ 'id' => 44 ])}}" class="btn for_more">Read
                                        More</a> -->
                                </div>
                            </div>
                        </div>
                        <div class="col-xl-4 col-lg-4 col-md-4 col-sm-6 col-xs-6 col-6">
                            <div class="card ">
                                <div class="card-body">
                                    <img class="card-img" src="{{asset('Assests/Body_wear/10.png') }}">
                                    <h4 class="card-text">Naval Belt Salt</h4>
                                    <!-- <a href="{{route('Product-Details',[ 'id' => 45 ])}}" class="btn for_more">Read
                                        More</a> -->
                                </div>
                            </div>
                        </div>
                        <div class="col-xl-4 col-lg-4 col-md-4 col-sm-6 col-xs-6 col-6">
                            <div class="card ">
                                <div class="card-body">
                                    <img class="card-img" src="{{asset('Assests/Body_wear/salt_braclets.png') }}">
                                    <h4 class="card-text"> Salt Bracelet</h4>
                                    <!-- <a href="{{route('Product-Details',[ 'id' => 43 ])}}" class="btn for_more">Read
                                        More</a> -->
                                </div>
                            </div>
                        ...
                        <div class="col-xl-4 col-lg-4 col-md-4 col-sm-6 col-xs-6 col-6">
                            <div class="card ">
                                <div class="card-body">
                                    <img class="card-img" src="{{asset('Assests/Body_wear/salt_pendant.png') }}">
                                    <h4 class="card-text"> Salt Pendant</h4>
                                    <!-- <a href="{{route('Product-Details',[ 'id' => 44 ])}}" class="btn for_more">Read
                                        More</a> -->
                                </div>
                            </div>
                        ...
                        <div class="col-xl-4 col-lg-4 col-md-4 col-sm-6 col-xs-6 col-6">
                            <div class="card ">
                                <div class="card-body">
                                    <img class="card-img" src="{{asset('Assests/Body_wear/naval_belt.png') }}">
                                    <h4 class="card-text">Naval Belt Salt</h4>
                                    <!-- <a href="{{route('Product-Details',[ 'id' => 45 ])}}" class="btn for_more">Read
                                        More</a> -->
                                </div>

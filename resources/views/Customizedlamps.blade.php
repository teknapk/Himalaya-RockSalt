                ...
                <div class="main-box">
                    <div id="carouselExampleIndicators" class="carousel slide" data-ride="carousel">
                        ...
                        <div class="carousel-inner">
                            ...
                            <img class="d-block w-100" src="{{ asset("Assests/Home/custom_slider.jpg")}}"
                                    alt="Second slide" id="d-block">
                               
                            </div>
                            <div class="carousel-item">
                            <img class="d-block w-100" src="{{ asset("Assests/Home/custom_slider2.jpg")}}"
                    ...
                    <div class="row pt-2">
                    <!-- <div class="col-xl-6 col-lg-6 col-md-6 col-sm-6 col-xs-6 col-6 mobile_view web_view mt-3">
                        <div class="">
                        <p>All Products</p>
                        </div>
                   ...
                   <a href="{{route('description',[  'id' => '1' ])}}">
                    ...
                    <div class="row">
                        ...
                        <div class="col-xl-4 col-lg-4 col-md-4 col-sm-6 col-xs-6 col-6">
                            <div class="card ">
                                <div class="card-body">
                                    <img class="card-img" src="{{asset('Assests/Theuraputic_salt/img3.png') }}">
                                    <h4 class="card-text">Cone Lamp</h4>
                                    <!-- <a href="{{route('Product-Details',[ 'id' => 3 ])}}" class="btn for_more">Read
                                        More</a> -->
                                </div>
                            </div>
                        </div>
                        <div class="col-xl-4 col-lg-4 col-md-4 col-sm-6 col-xs-6 col-6">
                            <div class="card ">
                                <div class="card-body">
                                    <img class="card-img" src="{{asset('Assests/Theuraputic_salt/img4.png') }}">
                                    <h4 class="card-text">Cone Lamp</h4>
                                    <!-- <a href="{{route('Product-Details',[ 'id' => 4 ])}}" class="btn for_more">Read
                                        More</a> -->
                                </div>
                            </div>
                        </div>
                        <div class="col-xl-4 col-lg-4 col-md-4 col-sm-6 col-xs-6 col-6">
                            <div class="card ">
                                <div class="card-body">
                                    <img class="card-img" src="{{asset('Assests/Theuraputic_salt/img6.png') }}">
                                    <h4 class="card-text">Tomb Lamp</h4>
                                    <!-- <a href="{{route('Product-Details',[ 'id' => 6 ])}}" class="btn for_more">Read
                                        More</a> -->
                                </div>
                            </div>
                        </div>
                        <div class="col-xl-4 col-lg-4 col-md-4 col-sm-6 col-xs-6 col-6">
                            <div class="card ">
                                <div class="card-body">
                                    <img class="card-img" src="{{asset('Assests/Theuraputic_salt/img7.png') }}">
                                    <h4 class="card-text">Leaf Lamp</h4>
                                    <!-- <a href="{{route('Product-Details',[ 'id' => 7 ])}}" class="btn for_more">Read
                                        More</a> -->
                                </div>
                            </div>
                        </div>
                        <div class="col-xl-4 col-lg-4 col-md-4 col-sm-6 col-xs-6 col-6">
                            <div class="card ">
                                <div class="card-body">
                                    <img class="card-img" src="{{asset('Assests/Theuraputic_salt/img8.png') }}">
                                    <h4 class="card-text">Dome Lamp</h4>
                                    <!-- <a href="{{route('Product-Details',[ 'id' => 8 ])}}" class="btn for_more">Read
                                        More</a> -->
                                </div>
                            </div>
                        </div>
                        <div class="col-xl-4 col-lg-4 col-md-4 col-sm-6 col-xs-6 col-6">
                            <div class="card ">
                                <div class="card-body">
                                    <img class="card-img" src="{{asset('Assests/Theuraputic_salt/img9.png') }}">
                                    <h4 class="card-text">Column Lamp</h4>
                                    <!-- <a href="{{route('Product-Details',[ 'id' => 9 ])}}" class="btn for_more">Read
                                        More</a> -->
                                </div>
                            </div>
                        </div>
                        <div class="col-xl-4 col-lg-4 col-md-4 col-sm-6 col-xs-6 col-6">
                            <div class="card ">
                                <div class="card-body">
                                    <img class="card-img" src="{{asset('Assests/Theuraputic_salt/img10.png') }}">
                                    <h4 class="card-text">White Salt and Grey Salt Lamps</h4>
                                    <!-- <a href="{{route('Product-Details',[ 'id' => 10 ])}}" class="btn for_more">Read
                                        More</a> -->
                                </div>
                            </div>
                        </div>
                        <div class="col-xl-4 col-lg-4 col-md-4 col-sm-6 col-xs-6 col-6">
                            <div class="card ">
                                <div class="card-body">
                                    <img class="card-img" src="{{asset('Assests/Theuraputic_salt/img11.png') }}">
                                    <h4 class="card-text">Ball Lamp with Marble Base</h4>
                                    <!-- <a href="{{route('Product-Details',[ 'id' => 11 ])}}" class="btn for_more">Read
                                        More</a> -->
                                </div>
                            </div>
                        </div>
                        <div class="col-xl-4 col-lg-4 col-md-4 col-sm-6 col-xs-6 col-6">
                            <div class="card ">
                                <div class="card-body">
                                    <img class="card-img" src="{{asset('Assests/Theuraputic_salt/img12.png') }}">
                                    <h4 class="card-text">Natural Lamps with marble base</h4>
                                    <!-- <a href="{{route('Product-Details',[ 'id' => 12 ])}}" class="btn for_more">Read
                                        More</a> -->
                                </div>
                            </div>
                        </div>
                        <div class="col-xl-4 col-lg-4 col-md-4 col-sm-6 col-xs-6 col-6">
                            <div class="card ">
                                <div class="card-body">
                                    <img class="card-img" src="{{asset('Assests/Theuraputic_salt/img13.png') }}">
                                    <h4 class="card-text">Single Wave</h4>
                                    <!-- <a href="{{route('Product-Details',[ 'id' => 13 ])}}" class="btn for_more">Read
                                        More</a> -->
                                </div>
                            </div>
                        </div>
                        <div class="col-xl-4 col-lg-4 col-md-4 col-sm-6 col-xs-6 col-6">
                            <div class="card ">
                                <div class="card-body">
                                    <img class="card-img" src="{{asset('Assests/Theuraputic_salt/img14.png') }}">
                                    <h4 class="card-text">Lotus Bowl and Lamp</h4>
                                    <!-- <a href="{{route('Product-Details',[ 'id' => 14 ])}}" class="btn for_more">Read
                                        More</a> -->
                                </div>
                            </div>
                        </div>
                        <div class="col-xl-4 col-lg-4 col-md-4 col-sm-6 col-xs-6 col-6">
                            <div class="card ">
                                <div class="card-body">
                                    <img class="card-img" src="{{asset('Assests/Theuraputic_salt/img38.png') }}">
                                    <h4 class="card-text">Rose Large</h4>
                                    <!-- <a href="{{route('Product-Details',[ 'id' => 2 ])}}" class="btn for_more">Read
                                        More</a> -->
                                </div>
                            </div>
                        </div>
                        <div class="col-xl-4 col-lg-4 col-md-4 col-sm-6 col-xs-6 col-6">
                            <div class="card ">
                                <div class="card-body">
                                    <img class="card-img" src="{{asset('Assests/Theuraputic_salt/img40.png') }}">
                                    <h4 class="card-text">Rose Lamp</h4>
                                    <!-- <a href="{{route('Product-Details',[ 'id' => 91 ])}}" class="btn for_more">Read
                                        More</a> -->
                                </div>
                            </div>
                        </div>
                        <div class="col-xl-4 col-lg-4 col-md-4 col-sm-6 col-xs-6 col-6">
                            <div class="card ">
                                <div class="card-body">
                                    <img class="card-img" src="{{asset('Assests/Theuraputic_salt/img39.png') }}">
                                    <h4 class="card-text">Salt Bowl </h4>
                                    <!-- <a href="{{route('Product-Details',[ 'id' => 90 ])}}" class="btn for_more">Read
                                        More</a> -->
                                </div>
                            </div>
                        </div>
                        <div class="col-xl-4 col-lg-4 col-md-4 col-sm-6 col-xs-6 col-6">
                            <div class="card ">
                                <div class="card-body">
                                    <img class="card-img" src="{{asset('Assests/Theuraputic_salt/tiles.jpg') }}">
                                    <h4 class="card-text">3D Square Tiles </h4>
                                    <!-- <a href="{{route('Product-Details',[ 'id' => 104 ])}}" class="btn for_more">Read
                                        More</a> -->
                                </div>
                            </div>
                        </div>
                        <div class="col-xl-4 col-lg-4 col-md-4 col-sm-6 col-xs-6 col-6">
                            <div class="card ">
                                <div class="card-body">
                                    <img class="card-img" src="{{asset('Assests/Theuraputic_salt/saltart.jpg') }}">
                                    <h4 class="card-text">Salt Art Hut </h4>
                                    <!-- <a href="{{route('Product-Details',[ 'id' => 90 ])}}" class="btn for_more">Read
                                        More</a> -->
                                </div>
                            </div>
                        ...
                        <div class="col-xl-4 col-lg-4 col-md-4 col-sm-6 col-xs-6 col-6">
                            <div class="card ">
                                <div class="card-body">
                                    <img class="card-img" src="{{asset('Assests/Theuraputic_salt/round.jpg') }}">
                                    <h4 class="card-text">3D Round Tiles </h4>
                                    <!-- <a href="{{route('Product-Details',[ 'id' => 90 ])}}" class="btn for_more">Read
                                        More</a> -->
                                </div>
                            </div>
                        ...
                        <div class="col-xl-4 col-lg-4 col-md-4 col-sm-6 col-xs-6 col-6">
                            <div class="card ">
                                <div class="card-body">
                                    <img class="card-img" src="{{asset('Assests/Theuraputic_salt/bowl.jpg') }}">
                                    <h4 class="card-text">8 Inch Bowl </h4>
                                    <!-- <a href="{{route('Product-Details',[ 'id' => 90 ])}}" class="btn for_more">Read
                                        More</a> -->
                                </div>
                            </div>
                        ...
                        <div class="col-xl-4 col-lg-4 col-md-4 col-sm-6 col-xs-6 col-6">
                            <div class="card ">
                                <div class="card-body">
                                    <img class="card-img" src="{{asset('Assests/Theuraputic_salt/pyramid.jpg') }}">
                                    <h4 class="card-text">pyramid </h4>
                                    <!-- <a href="{{route('Product-Details',[ 'id' => 90 ])}}" class="btn for_more">Read
                                        More</a> -->
                                </div>
                            </div>
                        ...
                        <div class="col-xl-4 col-lg-4 col-md-4 col-sm-6 col-xs-6 col-6">
                            <div class="card ">
                                <div class="card-body">
                                    <img class="card-img" src="{{asset('Assests/Theuraputic_salt/bowl.jpg') }}">
                                    <h4 class="card-text">6 Inch Bowl </h4>
                                    <!-- <a href="{{route('Product-Details',[ 'id' => 90 ])}}" class="btn for_more">Read
                                        More</a> -->
                                </div>
                            </div>
                        ...
                        <div class="col-xl-4 col-lg-4 col-md-4 col-sm-6 col-xs-6 col-6">
                            <div class="card ">
                                <div class="card-body">
                                    <img class="card-img" src="{{asset('Assests/Theuraputic_salt/Picture9.jpg') }}">
                                    <h4 class="card-text">8 INCH BOWL WITH HEART STONES </h4>
                                    <!-- <a href="{{route('Product-Details',[ 'id' => 90 ])}}" class="btn for_more">Read
                                        More</a> -->
                                </div>
                            </div>

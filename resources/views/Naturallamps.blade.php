                ...
                <div class="main-box">
                    <div id="carouselExampleIndicators" class="carousel slide" data-ride="carousel">
                        ...
                        <div class="carousel-inner">
                            <div class="carousel-item active">
                                <img class="d-block w-100" src="{{ asset("Assests/Home/natural_slider.jpg")}}"
                                    alt="First slide" id="d-block">
                            </div>
                            <div class="carousel-item">
                                <img class="d-block w-100" src="{{ asset("Assests/Home/new.jpg")}}"
                    ...
                    <div class="row">
                        <div class="col-xl-4 col-lg-4 col-md-4 col-sm-6 col-xs-6 col-6">
                            <div class="card ">
                                <div class="card-body">
                                    <img class="card-img" src="{{asset('Assests/Natural_lamps/N_1.jpg') }}">
                                    <h4 class="card-text">Natural Lamp on Camel Stand</h4>
                                    <!-- <a href="{{route('Product-Details',[ 'id' => 103])}}" class="btn for_more">Read
                                        More</a> -->
                                </div>
                            </div>
                        </div>
                        <div class="col-xl-4 col-lg-4 col-md-4 col-sm-6 col-xs-6 col-6">
                            <div class="card ">
                                <div class="card-body">
                                    <img class="card-img" src="{{asset('Assests/Natural_lamps/N_2.jpg') }}">
                                    <h4 class="card-text">Natural Lamp 3-5 Kg</h4>
                                    <!-- <a href="{{route('Product-Details',[ 'id' => 102])}}" class="btn for_more">Read
                                        More</a> -->
                                </div>
                            </div>
                        </div>
                        <div class="col-xl-4 col-lg-4 col-md-4 col-sm-6 col-xs-6 col-6">
                            <div class="card ">
                                <div class="card-body">
                                    <img class="card-img" src="{{asset('Assests/Natural_lamps/N_3.jpg') }}">
                                    <h4 class="card-text">Natural Aroma Lamp</h4>
                                    <!-- <a href="{{route('Product-Details',[ 'id' => 101])}}" class="btn for_more">Read
                                        More</a> -->
                                </div>
                            </div>
                        </div>
                        <div class="col-xl-4 col-lg-4 col-md-4 col-sm-6 col-xs-6 col-6">
                            <div class="card ">
                                <div class="card-body">
                                    <img class="card-img" src="{{asset('Assests/Natural_lamps/N_4.jpg') }}">
                                    <h4 class="card-text">Medium Natural Lamp</h4>
                                    <!-- <a href="{{route('Product-Details',[ 'id' => 100])}}" class="btn for_more">Read
                                        More</a> -->
                                </div>
                            </div>
                        </div>
                        <div class="col-xl-4 col-lg-4 col-md-4 col-sm-6 col-xs-6 col-6">
                            <div class="card ">
                                <div class="card-body">
                                    <img class="card-img" src="{{asset('Assests/Natural_lamps/N_5.jpg') }}">
                                    <h4 class="card-text">Small Natural Lamp</h4>
                                    <!-- <a href="{{route('Product-Details',[ 'id' => 99])}}" class="btn for_more">Read
                                        More</a> -->
                                </div>
                            </div>
                        </div>
                        <div class="col-xl-4 col-lg-4 col-md-4 col-sm-6 col-xs-6 col-6">
                            <div class="card ">
                                <div class="card-body">
                                    <img class="card-img" src="{{asset('Assests/Natural_lamps/N_6.jpg') }}">
                                    <h4 class="card-text">Natural Lamp 5-7 Kg</h4>
                                    <!-- <a href="{{route('Product-Details',[ 'id' => 98])}}" class="btn for_more">Read
                                        More</a> -->
                                </div>
                            </div>
                        </div>
                        <div class="col-xl-4 col-lg-4 col-md-4 col-sm-6 col-xs-6 col-6">
                            <div class="card ">
                                <div class="card-body">
                                    <img class="card-img" src="{{asset('Assests/Natural_lamps/N_7.jpg') }}">
                                    <h4 class="card-text">Natural lamp on Iron Stand</h4>
                                    <!-- <a href="{{route('Product-Details',[ 'id' => 97])}}" class="btn for_more">Read
                                        More</a> -->
                                </div>
                            </div>
                        </div>
                        <div class="col-xl-4 col-lg-4 col-md-4 col-sm-6 col-xs-6 col-6">
                            <div class="card ">
                                <div class="card-body">
                                    <img class="card-img" src="{{asset('Assests/Natural_lamps/N_8.jpg') }}">
                                    <h4 class="card-text">Natural Lamp Large 8-10 Kg</h4>
                                    <!-- <a href="{{route('Product-Details',[ 'id' => 96])}}" class="btn for_more">Read
                                        More</a> -->
                                </div>
                            </div>
                        </div>
                        <div class="col-xl-4 col-lg-4 col-md-4 col-sm-6 col-xs-6 col-6">
                            <div class="card ">
                                <div class="card-body">
                                    <img class="card-img" src="{{asset('Assests/Natural_lamps/N_9.jpg') }}">
                                    <h4 class="card-text">Natural Lamp Extra Large 11-15 Kg</h4>
                                    <!-- <a href="{{route('Product-Details',[ 'id' => 95])}}" class="btn for_more">Read
                                        More</a> -->
                                </div>
                            </div>
                        </div>
                        <div class="col-xl-4 col-lg-4 col-md-4 col-sm-6 col-xs-6 col-6">
                            <div class="card ">
                                <div class="card-body">
                                    <img class="card-img" src="{{asset('Assests/Natural_lamps/N_10.png') }}">
                                    <h4 class="card-text">Natural Tealight on Mini Camel Stand</h4>
                                    <!-- <a href="{{route('Product-Details',[ 'id' => 94])}}" class="btn for_more">Read
                                        More</a> -->
                                </div>
                            </div>
                        </div>
                        <div class="col-xl-4 col-lg-4 col-md-4 col-sm-6 col-xs-6 col-6">
                            <div class="card ">
                                <div class="card-body">
                                    <img class="card-img" src="{{asset('Assests/Natural_lamps/N_11.png') }}">
                                    <h4 class="card-text">Natural Mini Lamp 1-2 Kg on Medium Camel Stand</h4>
                                    <!-- <a href="{{route('Product-Details',[ 'id' => 93])}}" class="btn for_more">Read
                                        More</a> -->
                                </div>
                            </div>
                        </div>
                        <div class="col-xl-4 col-lg-4 col-md-4 col-sm-6 col-xs-6 col-6">
                            <div class="card ">
                                <div class="card-body">
                                    <img class="card-img" src="{{asset('Assests/Natural_lamps/N_12.jpg') }}">
                                    <h4 class="card-text">WHITE LAYERED SPECIAL LAMP</h4>
                                    <!-- <a href="{{route('Product-Details',[ 'id' => 92])}}" class="btn for_more">Read
                                        More</a> -->
                                </div>
                            </div>
                        </div>
                        <div class="col-xl-4 col-lg-4 col-md-4 col-sm-6 col-xs-6 col-6">
                            <div class="card ">
                                <div class="card-body">
                                    <img class="card-img" src="{{asset('Assests/Natural_lamps/N_13.jpg') }}">
                                    <h4 class="card-text">NATURAL LAMP</h4>
                                    <!-- <a href="{{route('Product-Details',[ 'id' => 92])}}" class="btn for_more">Read
                                        More</a> -->
                                </div>
                            </div>

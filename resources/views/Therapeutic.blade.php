                    ...
                    <div id="carouselExampleIndicators" class="carousel slide" data-ride="carousel">
                        ...
                        <div class="carousel-inner">
                            <div class="carousel-item active">
                                <img class="d-block w-100" src="{{ asset("Assests/Home/all.jpg")}}"
                   ...
                   <a href="{{route('description',[  'id' => '1' ])}}">
                    ...
                    <div class="row">
                        <div class="col-xl-4 col-lg-4 col-md-4 col-sm-6 col-xs-6 col-6">
                            <div class="card ">
                                <div class="card-body">
                                    <img class="card-img" src="Assests/Theuraputic_salt/img25.png">
                                    <h4 class="card-text">5 Inch Bowl</h4>
                        ...
                        <div class="col-xl-4 col-lg-4 col-md-4 col-sm-6 col-xs-6 col-6">
                            <div class="card ">
                                <div class="card-body">
                                    ...
                                    <h4 class="card-text">Lotus Base & Lamp</h4>

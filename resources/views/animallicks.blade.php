            ...
            <div class=" col-xl-3 col-lg-3 col-md-3 col-sm-3 col-xs-3 col-3 p-0 ctg-list mt-4">
                ...
                <!-- <div class="side-bar">
                    <ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion " id="accordionSidebar">
                        ...
                        <li class="nav-item ">
                            <a class="nav-link collapsed" href="{{ route('therapeutic') }}" 
                        ...
                        <li class="nav-item">
                            <a class="nav-link collapsed" href="{{route('miniusb')}}" aria-expanded="true"
                                aria-controls="collapsePages" style="padding-top: 0px; padding-bottom: 0px;">
                                <img src="img/assets/collections.png" alt="">
                                <span class="color-black">Mini USB Lamps</span></a>
                        </li>
                    ...
                    <div id="carouselExampleIndicators" class="carousel slide" data-ride="carousel">
                        ...
                        <div class="carousel-inner">
                            <div class="carousel-item active">
                                <img class="d-block w-100" src="{{asset('Assests/Home/animal_slider.jpg') }}"
                                    alt="First slide" id="d-block">
                            </div>
                            <div class="carousel-item">
                                <img class="d-block w-100" src="{{asset('Assests/Home/animal_slider2.jpg') }}"
                   ...
                   <a href="{{route('description',[  'id' => '8' ])}}">
                    ...
                    <div class="row">
                        <div class="col-xl-4 col-lg-4 col-md-4 col-sm-6 col-xs-6 col-6">
                            <div class="card ">
                                <div class="card-body">
                                    <img class="card-img" src="{{asset('Assests/Animal_Lick/21.png') }}">
                                    <h4 class="card-text">Animal Lick and compressed salt </h4>
                                    <!-- <a href="{{route('Product-Details',[ 'id' => 31 ])}}" class="btn for_more">Read
                                        More</a> -->
                                </div>
                            </div>
                        </div>
                        <div class="col-xl-4 col-lg-4 col-md-4 col-sm-6 col-xs-6 col-6">
                            <div class="card ">
                                <div class="card-body">
                                    <img class="card-img" src="{{asset('Assests/Animal_Lick/22.png') }}">
                                    <h4 class="card-text">Animal Lick</h4>
                                    <!-- <a href="{{route('Product-Details',[ 'id' => 32 ])}}" class="btn for_more">Read
                                        More</a> -->
                                </div>
                            </div>
                        </div>
                        <div class="col-xl-4 col-lg-4 col-md-4 col-sm-6 col-xs-6 col-6">
                            <div class="card ">
                                <div class="card-body">
                                    <img class="card-img" src="{{asset('Assests/Animal_Lick/23.png') }}">
                                    <h4 class="card-text">Animal Lick</h4>
                                    <!-- <a href="{{route('Product-Details',[ 'id' => 33 ])}}" class="btn for_more">Read
                                        More</a> -->
                                </div>
                            </div>
                        </div>
                        <div class="col-xl-4 col-lg-4 col-md-4 col-sm-6 col-xs-6 col-6">
                            <div class="card ">
                                <div class="card-body">
                                    <img class="card-img" src="{{asset('Assests/Animal_Lick/26.png') }}">
                                    <h4 class="card-text">Animal Lick </h4>
                                    <!-- <a href="{{route('Product-Details',[ 'id' => 35 ])}}" class="btn for_more">Read
                                        More</a> -->
                                </div>
                            </div>
                        </div>
                        <div class="col-xl-4 col-lg-4 col-md-4 col-sm-6 col-xs-6 col-6">
                            <div class="card ">
                                <div class="card-body">
                                    <img class="card-img" src="{{asset('Assests/Animal_Lick/25.png') }}">
                                    <h4 class="card-text">Animal Lick </h4>
                                    <!-- <a href="{{route('Product-Details',[ 'id' => 34 ])}}" class="btn for_more">Read
                                        More</a> -->
                                </div>
                            </div>
                        </div>
                        <div class="col-xl-4 col-lg-4 col-md-4 col-sm-6 col-xs-6 col-6">
                            <div class="card ">
                                <div class="card-body">
                                    <img class="card-img" src="{{asset('Assests/Animal_Lick/stonelick.png') }}">
                                    <h4 class="card-text">Natural Stone Lick Unshaped </h4>
                                    <!-- <a href="{{route('Product-Details',[ 'id' => 34 ])}}" class="btn for_more">Read
                                        More</a> -->
                                </div>
                            </div>
                        ...
                        <div class="col-xl-4 col-lg-4 col-md-4 col-sm-6 col-xs-6 col-6">
                            <div class="card ">
                                <div class="card-body">
                                    <img class="card-img" src="{{asset('Assests/Animal_Lick/qualitylick.png') }}">
                                    <h4 class="card-text">Premium Quality Lick </h4>
                                    <!-- <a href="{{route('Product-Details',[ 'id' => 34 ])}}" class="btn for_more">Read
                                        More</a> -->
                                </div>
                            </div>
                        ...
                        <div class="col-xl-4 col-lg-4 col-md-4 col-sm-6 col-xs-6 col-6">
                            <div class="card ">
                                <div class="card-body">
                                    <img class="card-img" src="{{asset('Assests/Animal_Lick/shapelick.png') }}">
                                    <h4 class="card-text">Natural Shape Lick </h4>
                                    <!-- <a href="{{route('Product-Details',[ 'id' => 34 ])}}" class="btn for_more">Read
                                        More</a> -->
                                </div>
                            </div>
                        ...
                        <div class="col-xl-4 col-lg-4 col-md-4 col-sm-6 col-xs-6 col-6">
                            <div class="card ">
                                <div class="card-body">
                                    <img class="card-img" src="{{asset('Assests/Animal_Lick/animal_lick.jpg') }}">
                                    <h4 class="card-text">Animal Lick </h4>
                                    <!-- <a href="{{route('Product-Details',[ 'id' => 34 ])}}" class="btn for_more">Read
                                        More</a> -->
                                </div>
                        ...
                        <div class="col-xl-4 col-lg-4 col-md-4 col-sm-6 col-xs-6 col-6">
                            <div class="card ">
                                <div class="card-body">
                                    <img class="card-img" src="{{asset('Assests/Animal_Lick/animal_lick2.jpg') }}">
                                    <h4 class="card-text">Animal Lick </h4>
                                    <!-- <a href="{{route('Product-Details',[ 'id' => 34 ])}}" class="btn for_more">Read
                                        More</a> -->
                                </div>

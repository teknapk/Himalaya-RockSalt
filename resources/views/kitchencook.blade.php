                ...
                <div class="main-box">
                    <div id="carouselExampleIndicators" class="carousel slide" data-ride="carousel">
                        ...
                        <div class="carousel-inner">
                            ...
                            <img class="d-block w-100" src="{{asset('Assests/Home/kitchen_slider.png') }}"
                                    alt="Second slide" id="d-block">
                            </div>
                            <div class="carousel-item">
                               
                                    <img class="d-block w-100" src="{{asset('Assests/Home/kitchen_slider2.jpg') }}"
                   ...
                   <a href="{{route('description',[  'id' => '5' ])}}">
                    ...
                    <div class="row">
                        <div class="col-xl-4 col-lg-4 col-md-4 col-sm-6 col-xs-6 col-6">
                            <div class="card ">
                                <div class="card-body">
                                    <img class="card-img" src="{{asset('Assests/Kitchen_Cook/img75.png') }}">
                                    <h4 class="card-text">Salt Glasses</h4>
                                    <!-- <a href="{{route('Product-Details',[ 'id' => 66])}}" class="btn for_more">Read
                                        More</a> -->
                                </div>
                            </div>
                        </div>
                        <div class="col-xl-4 col-lg-4 col-md-4 col-sm-6 col-xs-6 col-6">
                            <div class="card ">
                                <div class="card-body">
                                    <img class="card-img" src="{{asset('Assests/Kitchen_Cook/img76.png') }}">
                                    <h4 class="card-text">KITCHEN AND COOK WARE</h4>
                                    <!-- <a href="{{route('Product-Details',[ 'id' => 66])}}" class="btn for_more">Read
                                        More</a> -->
                                </div>
                            </div>
                        ...
                        <div class="col-xl-4 col-lg-4 col-md-4 col-sm-6 col-xs-6 col-6">
                            <div class="card ">
                                <div class="card-body">
                                    <img class="card-img" src="{{asset('Assests/Kitchen_Cook/img77.png') }}">
                                    <h4 class="card-text">KITCHEN AND COOK WARE</h4>
                                    <!-- <a href="{{route('Product-Details',[ 'id' => 66])}}" class="btn for_more">Read
                                        More</a> -->
                                </div>
                        ...
                        <div class="col-xl-4 col-lg-4 col-md-4 col-sm-6 col-xs-6 col-6">
                            <div class="card ">
                                <div class="card-body">
                                    <img class="card-img" src="{{asset('Assests/Kitchen_Cook/img78.png') }}">
                                    <h4 class="card-text">KITCHEN AND COOK WARE</h4>
                                    <!-- <a href="{{route('Product-Details',[ 'id' => 66])}}" class="btn for_more">Read
                                        More</a> -->
                                </div>
                        ...
                        <div class="col-xl-4 col-lg-4 col-md-4 col-sm-6 col-xs-6 col-6">
                            <div class="card ">
                                <div class="card-body">
                                    <img class="card-img" src="{{asset('Assests/Kitchen_Cook/img79.png') }}">
                                    <h4 class="card-text">KITCHEN AND COOK WARE</h4>
                                    <!-- <a href="{{route('Product-Details',[ 'id' => 66])}}" class="btn for_more">Read
                                        More</a> -->
                                </div>
                        ...
                        <div class="col-xl-4 col-lg-4 col-md-4 col-sm-6 col-xs-6 col-6">
                            <div class="card ">
                                <div class="card-body">
                                    <img class="card-img" src="{{asset('Assests/Kitchen_Cook/img85.png') }}">
                                    <h4 class="card-text">10 & 16 Inch Platters</h4>
                                    <!-- <a href="{{route('Product-Details',[ 'id' => 75])}}" class="btn for_more">Read
                                        More</a> -->
                                </div>
                            </div>
                        </div>
                        <div class="col-xl-4 col-lg-4 col-md-4 col-sm-6 col-xs-6 col-6">
                            <div class="card ">
                                <div class="card-body">
                                    <img class="card-img" src="{{asset('Assests/Kitchen_Cook/kc-3.jpg') }}">
                                    <h4 class="card-text">Salt Bricks 8x4x2 inch</h4>
                                    <!-- <a href="{{route('Product-Details',[ 'id' => 80])}}" class="btn for_more">Read
                                        More</a> -->
                                </div>
                            </div>
                        </div>
                        <div class="col-xl-4 col-lg-4 col-md-4 col-sm-6 col-xs-6 col-6">
                            <div class="card ">
                                <div class="card-body">
                                    <img class="card-img" src="{{asset('Assests/Kitchen_Cook/img80.png') }}">
                                    <h4 class="card-text">8 inch round platters</h4>
                                    <!-- <a href="{{route('Product-Details',[ 'id' => 71])}}" class="btn for_more">Read
                                        More</a> -->
                                </div>
                            </div>
                        </div>
                        <div class="col-xl-4 col-lg-4 col-md-4 col-sm-6 col-xs-6 col-6">
                            <div class="card ">
                                <div class="card-body">
                                    <img class="card-img" src="{{asset('Assests/Kitchen_Cook/img81.png') }}">
                                    <h4 class="card-text">Salt Tile Square 8</h4>
                                    <!-- <a href="{{route('Product-Details',[ 'id' => 72])}}" class="btn for_more">Read
                                        More</a> -->
                                </div>
                            </div>
                        </div>
                        <div class="col-xl-4 col-lg-4 col-md-4 col-sm-6 col-xs-6 col-6">
                            <div class="card ">
                                <div class="card-body">
                                    <img class="card-img" src="{{asset('Assests/Kitchen_Cook/img82.png') }}">
                                    <h4 class="card-text">Mortar and Pestle</h4>
                                    <!-- <a href="{{route('Product-Details',[ 'id' => 73])}}" class="btn for_more">Read
                                        More</a> -->
                                </div>
                            </div>
                        </div>
                        <div class="col-xl-4 col-lg-4 col-md-4 col-sm-6 col-xs-6 col-6">
                            <div class="card ">
                                <div class="card-body">
                                    <img class="card-img" src="{{asset('Assests/Kitchen_Cook/img83.png') }}">
                                    <h4 class="card-text">Salad Bowl</h4>
                                    <!-- <a href="{{route('Product-Details',[ 'id' => 74])}}" class="btn for_more">Read
                                        More</a> -->
                                </div>
                            </div>
                        </div>
                        <div class="col-xl-4 col-lg-4 col-md-4 col-sm-6 col-xs-6 col-6">
                            <div class="card ">
                                <div class="card-body">
                                    <img class="card-img" src="{{asset('Assests/Kitchen_Cook/img87.png') }}">
                                    <h4 class="card-text">Sushi Plates</h4>
                                    <!-- <a href="{{route('Product-Details',[ 'id' => 77])}}" class="btn for_more">Read
                                        More</a> -->
                                </div>
                            </div>
                        </div>
                        <div class="col-xl-4 col-lg-4 col-md-4 col-sm-6 col-xs-6 col-6">
                            <div class="card ">
                                <div class="card-body">
                                    <img class="card-img" src="{{asset('Assests/Kitchen_Cook/food.jpg') }}">
                                    <h4 class="card-text">Food Shelves</h4>
                                    <!-- <a href="{{route('Product-Details',[ 'id' => 77])}}" class="btn for_more">Read
                                        More</a> -->
                                </div>
                            </div>
                        ...
                        <div class="col-xl-4 col-lg-4 col-md-4 col-sm-6 col-xs-6 col-6">
                            <div class="card ">
                                <div class="card-body">
                                    <img class="card-img" src="{{asset('Assests/Kitchen_Cook/round.jpg') }}">
                                    <h4 class="card-text">200 MM ROUND SERVING TILES	</h4>
                        ...
                        <div class="col-xl-4 col-lg-4 col-md-4 col-sm-6 col-xs-6 col-6">
                            <div class="card ">
                                <div class="card-body">
                                    <img class="card-img" src="{{asset('Assests/Kitchen_Cook/img86.png') }}">
                                    <h4 class="card-text">SINGAL PLATTER	</h4>
                        ...
                        <div class="col-xl-4 col-lg-4 col-md-4 col-sm-6 col-xs-6 col-6">
                            <div class="card ">
                                <div class="card-body">
                                    <img class="card-img" src="{{asset('Assests/Kitchen_Cook/cooking_slab.jpg') }}">
                                    <h4 class="card-text">300X200X7.5 MM COOKING SLAB WITH TRAY</h4>
                        ...
                        <div class="col-xl-4 col-lg-4 col-md-4 col-sm-6 col-xs-6 col-6">
                            <div class="card ">
                                <div class="card-body">
                                    <img class="card-img" src="{{asset('Assests/Kitchen_Cook/extra_round.jpg') }}">
                                    <h4 class="card-text">200 MM ROUND, 300X200X7.5 MM </h4>
                        ...
                        <div class="col-xl-4 col-lg-4 col-md-4 col-sm-6 col-xs-6 col-6">
                            <div class="card ">
                                <div class="card-body">
                                    <img class="card-img" src="{{asset('Assests/Kitchen_Cook/rectangle.jpg') }}">
                                    <h4 class="card-text">RECTANGULAR & 200X5MM SQUARE TILES</h4>
                        ...
                        <div class="col-xl-4 col-lg-4 col-md-4 col-sm-6 col-xs-6 col-6">
                            <div class="card ">
                                <div class="card-body">
                                    <img class="card-img" src="{{asset('Assests/Kitchen_Cook/foodshelf.jpg') }}">
                                    <h4 class="card-text">Food Shelves</h4>
                        ...
                        <div class="col-xl-4 col-lg-4 col-md-4 col-sm-6 col-xs-6 col-6">
                            <div class="card ">
                                <div class="card-body">
                                    <img class="card-img" src="{{asset('Assests/Kitchen_Cook/kit.jpg') }}">
                                    <h4 class="card-text">Himalayan Kit with 30x20x4.5 cm salt slab </h4>
                        ...
                        <div class="col-xl-4 col-lg-4 col-md-4 col-sm-6 col-xs-6 col-6">
                            <div class="card ">
                                <div class="card-body">
                                    <img class="card-img" src="{{asset('Assests/Kitchen_Cook/wooden3.jpg') }}">
                                    <h4 class="card-text"> Salt Platter holder</h4>
                        ...
                        <div class="col-xl-4 col-lg-4 col-md-4 col-sm-6 col-xs-6 col-6">
                            <div class="card ">
                                <div class="card-body">
                                    <img class="card-img" src="{{asset('Assests/Kitchen_Cook/wooden2.jpg') }}">
                                    <h4 class="card-text">Round Salt Platter holder</h4>
                        ...
                        <div class="col-xl-4 col-lg-4 col-md-4 col-sm-6 col-xs-6 col-6">
                            <div class="card ">
                                <div class="card-body">
                                    <img class="card-img" src="{{asset('Assests/Kitchen_Cook/wooden1.jpg') }}">
                                    <h4 class="card-text">WOODEN TRAY</h4>
                        ...
                        <div class="col-xl-4 col-lg-4 col-md-4 col-sm-6 col-xs-6 col-6">
                            <div class="card ">
                                <div class="card-body">
                                    <img class="card-img" src="{{asset('Assests/Kitchen_Cook/platter.jpg') }}">
                                    <h4 class="card-text">40X20X10 CM COOKING PLATTER</h4>
